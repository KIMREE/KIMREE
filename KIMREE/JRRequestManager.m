                        ...
                        key:(NSString *)key
{
  ...
  //构造请求项
  JRRequest *item = [[JRRequest alloc] initWithMethod:method url:API_SERVER_URL params:data delegate:delegate key:key];
                   ...
                   finished:(THRequestFinishedBlock)finishedBlock
{
  ...
  //构造请求项
  JRRequest *item = [[JRRequest alloc] initWithMethod:method url:API_SERVER_URL params:data key:key failed:failedBlock finished:finishedBlock];
...
- (NSDictionary *)params:(NSDictionary *)params cmd:(NSString *)cmd
{
  ...
  [dict setValue:appHelper.qua forKey:@"qua"];
